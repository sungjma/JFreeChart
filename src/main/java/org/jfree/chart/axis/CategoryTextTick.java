 ...
 */
public class CategoryTextTick extends CategoryTick {
     ...
     */
    public CategoryTextTick(Comparable category,
                        TextBlock label,
                        TextBlockAnchor labelAnchor,
                        TextAnchor rotationAnchor,
                        double angle) {

        super(category, TextAnchor.CENTER, rotationAnchor, angle);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CategoryTextTick && super.equals(obj)) {
            CategoryTextTick that = (CategoryTextTick) obj;
